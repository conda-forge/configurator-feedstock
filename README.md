...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/configurator-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13801&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/configurator-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `configurator` can be installed with:

```
conda install configurator
```

It is possible to list all of the versions of `configurator` available on your platform with:
